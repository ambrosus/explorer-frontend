...
const OverallBalance: React.FC<OverallBalanceProps> = ({
  ...
  return (
    <div className="address_details_div">
      <span
        className="address_details_div_span universall_dark"
        style={{ fontWeight: 700, marginRight: 8 }}
      >
        Balance
      </span>
      <span className="address_details_div_span universall_dark">
        {`${
          balMemo ? Number(balMemo).toFixed(2) : Number(balance).toFixed(2)
        } AMB`}{' '}
      </span>
      <span className="address_details_div_span universall_dark">/</span>
      <span className="address_details_div_span universall_light2">{`$ ${
