...
const Method = ({index, method}: any) => {
    ...
    const contractCall = async (method: any) => {
      try {
        ...
        const sortKeysInObjectByRightParamsSequence = (obj: any) => {
          const rightParamsSequence = method.inputs.map((input: any, index: number) => {
            return input.name;
          });

          let keys = Object.keys(obj).sort((a: any, b: any) => {
            return rightParamsSequence.indexOf(a) - rightParamsSequence.indexOf(b);
          });
          let newObj: any = {};
        ...
        let value = input
          ? await contractWithSigner?.[`${method.name}`](...Object.values(sortKeysInObjectByRightParamsSequence(input)))
                ...
                return (
                  <div key={index} className="method-params-param">
                    ...
                    <ContractInput
                      ...
                      onChange={(e: any) => setInput((prev: any) => {
