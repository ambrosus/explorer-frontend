const BundleBlocksHeader = () => (
  <div className="bundle_blocks_header">
    ...
    <div className="bundle_blocks_header_cell">Entries</div>
    <div className="bundle_blocks_header_cell">Size</div>
    <div className="bundle_blocks_header_cell">Block</div>
    <div className="bundle_blocks_header_cell">Bundle cost</div>
  </div>
);

export default BundleBlocksHeader;
