    ...
    <div className="main_info_apollo">
      ...
      <div className="main_info_apollo_table">
        ...
        <div className="main_info_apollo_cell">
          ...
          <span className="main_info_apollo_cell_secondary"> {info.offline}</span>
        </div>
        <div className="main_info_apollo_cell">
        ...
        <span className="main_info_apollo_cell_primary">
          ...
          <span  > <Number  className='main_info_apollo_cell_secondary'  discharge='sec' value={appData?.netInfo?.avgBlockTime ? `${appData.netInfo.avgBlockTime}` : '0'} fixed={2}  /> </span>
        </div>
